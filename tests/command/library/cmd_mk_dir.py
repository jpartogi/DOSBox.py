...
class CmdMkDirTestCase(CommandBaseTestCase):
    ...
    def test_CmdMkDir_CreateNewDirectory_NewDirectoryIsAdded(self):
        ...
        self.assertEqual(self.number_of_dirs_before_test + 1, self.root_dir.number_of_contained_directories())
    ...
    def test_CmdMkDir_NoParameters_ErrorMessagePrinted(self):
        ...
        self.assertIn(Command.INCORRECT_SYNTAX, self.outputter.output)
    ...
    def test_CmdMkDir_ParameterContainsBacklash_NoDirectoryCreated(self):
        ...
        self.assertEqual(self.number_of_dirs_before_test, self.root_dir.number_of_contained_directories())
    ...
    def test_CmdMkDir_SeveralParameters_SeveralNewDirectoriesCreated(self):
        ...
        self.assertEqual(self.number_of_dirs_before_test + 3, self.root_dir.number_of_contained_directories())
    ...
    def test_CmdMkDir_AllParametersAreReset(self):
        ...
        self.assertEqual(self.number_of_dirs_before_test + 1, self.root_dir.number_of_contained_directories())
        self.assertEqual(Command.INCORRECT_SYNTAX, self.outputter.output)
